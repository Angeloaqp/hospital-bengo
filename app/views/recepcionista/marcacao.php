...
<body class="text-on-surface bg-background">
                    ...
                    <div class="flex-1 space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100 fill-mode-both relative z-40">
                                ...
                                <div class="relative custom-dropdown" id="specialty-dropdown">
                                    <button type="button" class="w-full h-14 px-5 bg-surface-container-low border-none rounded-[24px] font-semibold text-sm cursor-pointer hover:bg-surface-container transition-colors flex items-center justify-between" onclick="toggleDropdown('specialty-dropdown')">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <span class="text-on-surface" id="specialty-text">Seleccione a Especialidade...</span>
                                        </div>
                            ...
                            <section class="bg-white rounded-[32px] p-8 floating-card border border-white flex-1 relative z-30">
                                ...
                                <div class="flex items-center justify-between mb-8">
                                    <div class="flex items-center gap-3">
                                        <div class="w-10 h-10 rounded-[24px] bg-surface-container-low flex items-center justify-center shrink-0">
                                            <span class="material-symbols-outlined text-on-surface">priority</span>
                                        </div>
                        ...
                        <section class="bg-white rounded-[32px] p-8 floating-card border border-white min-h-[220px] relative animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200 fill-mode-both z-30">
                            ...
                            <div class="flex items-center justify-between mb-8">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 rounded-[24px] bg-surface-container-low flex items-center justify-center shrink-0">
                                        <span class="material-symbols-outlined text-on-surface">groups</span>
                                    </div>
                                ...
                                <div class="flex items-center justify-center w-full max-w-sm sm:w-auto">
                                    <label class="flex items-center cursor-pointer hover:opacity-80 transition-opacity" for="auto-mode-toggle">
                                        <div class="relative">
                                            ...
                                            <div class="block bg-surface-container-high w-10 h-6 rounded-full transition-colors duration-300 peer-checked:bg-primary" id="auto-toggle-bg"></div>
                        ...
                        <section class="bg-white rounded-[32px] p-8 floating-card border border-white relative animate-in fade-in slide-in-from-bottom-4 duration-500 delay-400 fill-mode-both">
                            <div class="flex items-center justify-between mb-8">
                                ...
                                <button type="button" onclick="adicionarContacto()" class="flex items-center gap-1.5 text-xs font-bold text-on-surface hover:bg-surface-container-low px-3 py-1.5 rounded-[12px] transition-colors active:scale-95">
                    ...
                    <div class="w-full lg:w-[340px] shrink-0 animate-in fade-in slide-in-from-right-8 duration-500 delay-300 fill-mode-both">
                        <div class="sticky top-32 space-y-6 flex flex-col items-center">
                                ...
                                <div class="px-8 py-2 space-y-6 relative z-10 font-headline">
                                    <div class="grid grid-cols-2 gap-x-4 gap-y-6">
                                        <div class="flex flex-col gap-1.5">
                                            ...
                                            <div>
                                                <p class="text-sm font-black text-on-surface leading-tight" id="resumo-paciente-nome">-</p>
                                        ...
                                        <div class="flex flex-col gap-1.5">
                                            ...
                                            <p class="text-sm font-black text-on-surface" id="resumo-especialidade">-</p>
                                        </div>
                                        <div class="flex flex-col gap-1.5">
                                            <p class="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">Médico</p>
                                            <div>
                                                <p class="text-sm font-black text-on-surface" id="resumo-medico">-</p>
                                        ...
                                        <div class="flex flex-col gap-1.5">
                                            ...
                                            <p class="text-sm font-black text-on-surface" id="resumo-prioridade">Regular</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="hidden w-full flex flex-col items-center animate-in fade-in zoom-in-95 slide-in-from-bottom-4 duration-700 ease-out" id="summary-senha">
                                        <div class="w-full flex justify-between items-center mb-6">
                                            <div class="text-left">
                                                ...
                                                <p class="text-3xl font-black text-on-surface tracking-tighter" id="sucesso-senha-codigo">---</p>
                                            </div>
                            ...
                            <div class="flex flex-col gap-3 w-full relative">
                                <button type="submit" id="btn-submit" class="w-full bg-primary text-white hover:bg-zinc-800 transition-all flex flex-col items-center justify-center gap-0.5 shadow-xl rounded-xl group active:scale-95 py-4">
                                ...
                                <!-- Toast -->
                                <div class="absolute bottom-full mb-4 left-1/2 -translate-x-1/2 w-72 bg-primary text-white px-6 py-4 rounded-[24px] shadow-[0_8px_30px_rgb(0,0,0,0.12)] flex items-center gap-3 opacity-0 translate-y-4 pointer-events-none transition-all duration-500 ease-out z-50" id="print-success-toast">
        ...
        function carregarMedicos() {
            ...
            fetch(BASE + 'app/controllers/agenda_api.php?acao=medicos_da_especialidade&especialidade_id=' + espId)
                ...
                <div class="flex items-center gap-4 p-4 rounded-[32px] bg-surface-container-low border-2 border-transparent peer-checked:border-black peer-checked:bg-white transition-all h-full">
                    ...
                    <div class="absolute top-4 right-4 w-4 h-4 rounded-full border-2 border-surface-variant peer-checked:border-black peer-checked:bg-primary flex items-center justify-center transition-colors">
    ...
    <div class="flex items-center justify-between mb-4 px-2">
        <button type="button" onclick="changeMonth(-1)" class="text-on-surface-variant hover:text-on-surface hover:bg-surface-container-low rounded-full p-1 transition-colors active:scale-95"><span class="material-symbols-outlined">chevron_left</span></button>
        <p class="text-xs font-bold text-on-surface uppercase tracking-widest">${monthsPT[currentMonth]} ${currentYear}</p>
        <button type="button" onclick="changeMonth(1)" class="text-on-surface-variant hover:text-on-surface hover:bg-surface-container-low rounded-full p-1 transition-colors active:scale-95"><span class="material-symbols-outlined">chevron_right</span></button>
    </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-surface-container-low rounded-[24px] border border-transparent hover:border-black/5 transition-colors group gap-4" id="contacto-${i}">
            <div class="flex items-center gap-4 flex-1">
                ...
                <div class="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <input type="text" name="contactos[${i}][valor]" value="${valor}" class="w-full bg-transparent border-b border-black/10 focus:border-black px-1 py-1 text-sm font-bold text-on-surface" placeholder="Contacto..." required>
            ...
            fetch(this.action, {
                ...
                .then(d => {
                    if (d.status === 'success') {
                        ...
                        secBtn.href = "#";
                        secBtn.onclick = function(ev) {
                            ev.preventDefault();
                            window.location.reload();
                        };
                        secBtn.classList.remove('text-zinc-400', 'hover:text-error', 'hover:bg-error/5');
                        secBtn.classList.add('text-on-surface', 'bg-surface-container-low', 'hover:bg-surface-container');
