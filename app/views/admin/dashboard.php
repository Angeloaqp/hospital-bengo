    ...
    <main class="ml-64 pt-24 h-screen overflow-y-auto custom-scrollbar">
        <div class="p-8 max-w-[1400px] mx-auto min-h-full pb-24">
            ...
            <div class="mb-10 flex justify-between items-end glide-in">
                ...
                <a href="utilizadores.php" class="bg-black text-white px-8 py-3.5 rounded-full font-bold text-sm flex items-center gap-2 hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="bg-white rounded-[2rem] p-6 border border-white/50 shadow-sm kpi-card glide-in stagger-4 relative overflow-hidden">
                    ...
                    <div class="mt-5 w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                        <div class="bg-black h-full rounded-full transition-all duration-1000 ease-out" style="width: 0%" data-target-width="<?= $taxaConclusao ?>%"></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        <?php foreach ($porPrio as $p):
                            ...
                            $cleanColor = $rawColor === '#ff0000' || strpos($rawColor, 'red') !== false ? 'bg-red-500' :
                                         ...
                                         ($rawColor === '#00cc00' || strpos($rawColor, 'green') !== false ? 'bg-green-500' : 'bg-black'));
                        ?>
