    ...
    <script>
        (function () {
            ...
            function makeBtn(icon, active, handler) {
                const btn = document.createElement('button');
                btn.className = `w-12 h-12 rounded-2xl bg-white flex items-center justify-center shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] btn-action transition-all ${active ? 'hover:bg-black hover:text-white' : 'opacity-30 cursor-default'
                    }`;
