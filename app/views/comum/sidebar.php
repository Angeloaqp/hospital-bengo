...
<aside id="desktop-sidebar" class="hidden lg:flex fixed left-6 top-6 bottom-6 flex-col py-6 z-[60] w-56 bg-white rounded-[2rem] floating-card font-['Manrope'] antialiased border border-white/50 transition-all duration-300">
    ...
    <div id="sidebar-top" class="mb-8 flex flex-col items-center px-6 gap-3 transition-all">
        <div class="flex flex-col items-center justify-center overflow-hidden h-16 w-full px-2">
            <img src="<?= BASE_URL ?>public/assets/img/logo_hhc.png" alt="HHC Logo" class="h-14 w-auto sidebar-text transition-all object-contain">
            <img src="<?= BASE_URL ?>public/assets/img/logo_hhc.png" alt="HHC" class="h-10 w-auto hidden sidebar-mini-text transition-all object-contain" style="object-position: left;">
        </div>
